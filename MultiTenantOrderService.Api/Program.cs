...
using MultiTenantOrderService.Api.Attributes;
using MultiTenantOrderService.Api.Extensions;
using MultiTenantOrderService.Api.Swagger;
using MultiTenantOrderService.Application;
using MultiTenantOrderService.Domain.Identity.ObjectValues;
using MultiTenantOrderService.Infrastructure;
...
// Register DbContext
builder.Services.AddDbContext< MultiTenantOrderService.Domain.DBContexts.OSContext>(options =>
{
...
builder.Services.AddScoped< MultiTenantOrderService.Infrastructure.Interfaces.IUserService,MultiTenantOrderService .Application.UserServices.UserService>();
builder.Services.AddScoped<MultiTenantOrderService.Infrastructure.Interfaces.IProductService, MultiTenantOrderService.Application.ProductServices.ProductService>();
